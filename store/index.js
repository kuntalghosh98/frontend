...
import highlightedProductsReducer from './slices/highlightedProductsSlice';
import productScrollListReducer from './slices/productScrollListSlice';
...
export const store = configureStore({
  reducer: {
    ...
    productScrollList: productScrollListReducer,
  },
});
